...
from .clifford import ParametrizedCliffordCircuit
from .evaluation import transform_paulis, get_energy, weighted_relative_pauli_weight
from .utils import n_to_dits
from .mp_helpers import SignalHandler
...
def loss_func(
    ...
    **energy_kwargs,
    ...
    if trans_pcirc is None:
        ...
        energy = get_energy(vqe_pcirc, paulis, coeffs, **energy_kwargs)
    ...
    **optimizer_and_loss_kwargs,
    ...
    while True:
        ...
        xs, losses = genetic_algorithm(
            paulis, coeffs, vqe_pcirc, trans_pcirc, **optimizer_and_loss_kwargs
        )
        best_count = len(xs)
